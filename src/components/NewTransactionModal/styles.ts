...
export const TransactionsTypeButton = styled(RadioGroup.Item)<TransactionsTypeButtonProps>`
  ...
  svg {
    color: ${props => props.variant === 'income' ? props.theme["blue-300"] : props.theme["red-300"]};
  }
  ...
  &[data-state='checked'] {
    color: ${props => props.theme.white};
    background: ${props => props.variant === 'income' ? props.theme['blue-300'] : props.theme["red-500"]};
